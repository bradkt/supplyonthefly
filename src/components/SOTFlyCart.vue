        ...
        <div class="modal fade" id="CheckoutModal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <span class="checkout-price">Product Total: <span class="checkout-num">${{ getCartTotal.toFixed(2) }}</span></span>
                    <span class="checkout-price">Total Sale: <span class="checkout-num">${{ ( getCartTotal + (getCartTotal * .1)).toFixed(2) }}</span></span>
                      ...
                      <form action="#">
                        ...
                        <p :class="{ 'control': true }">
                          <input v-validate="'required|date_format:MM/YY'" data-vv-delay="700"
                                 :class="{'input': true, 'is-danger': errors.has('expiry') }" name="expiry" type="text" placeholder="MM/YY">
                        ...
                        <button @click.prevent="login" type="button" :disabled="errors.any()" class="btn btn-primary">Make Payment</button>
